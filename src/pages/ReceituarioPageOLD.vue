   ...
   <v-container  style="background-color: #DCEDC8;" >
    ...
    <!-- <div v-if="(this.consultasFiltradas.length > 0)">              
        <label style="margin-top: 20%"><b> Quantidade de consultas realizadas: {{ consultasFiltradas.length }} </b></label>
         <AppReceituarioGrid v-for="(consulta, index) in consultasFiltradas" :key="index" :dados="consulta" />
...
<v-dialog v-model="dialog" persistent max-width="800">
      <v-card>
        ...
        <v-container id="relatorioPDF">
            ...
            <div id="receitaCompleta" v-if="tipoOperacao='atualiza'">
            <v-row class="justify-center">
              <v-col cols="auto"> <h2> RECEITUÁRIO CONTROLE ESPECIAL </h2></v-col>
            </v-row> 
            ...
            <v-row>
                ...
                <v-col cols="12" md="4"> CRM </v-col>
                <v-col cols="12" md="4"> UF REGISTRO </v-col>
            </v-row>   

            <v-row>
                <v-col cols="12" md="4"> TELEFONE </v-col>
                <v-col cols="12" md="4"> CIDADE </v-col>
                <v-col cols="12" md="4"> UF </v-col>
            </v-row>   

            <v-row>
                <v-col cols="12" md="4"> ENDEREÇO </v-col> 
            </v-row>
            ...
            <v-row>
                <v-col cols="12" md="4"> NOME COMPLETO </v-col>
                <v-col cols="12" md="4"> CRM </v-col>
                <v-col cols="12" md="4"> UF REGISTRO </v-col>
            </v-row>  
  ...
  export default           {
    ...
    methods:                      {
      ...
      async preencheCabecalhoReceita()          {
          ...
          var dados = await this.consultaPacienteByNome( this.usuario, this.filtros.nomePaciente );
